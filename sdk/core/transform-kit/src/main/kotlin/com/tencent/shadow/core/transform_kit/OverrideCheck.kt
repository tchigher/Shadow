...
class OverrideCheck {
     ...
     * value：Override的方法
     */
    private val methodMap: MutableMap<
            String,
            Collection<Method_OriginalDeclaringClass>
            > = hashMapOf()
    ...
    private fun String.isKotlinClass(
    ): Boolean {
        return startsWith("kotlin")
    }

    fun prepare(
            inputClasses: Set<CtClass>
    ) {
        methodMap.clear()
        ctClassMap.clear()
    ...
    fun getOverrideMethods(
    ) = methodMap.toImmutableMap()
