...
class PluginContentProviderManager() : UriConverter.UriParseDelegate {
    ...
    fun addContentProviderInfo(
            partKey: String,
            pluginProviderInfo: PluginProviderInfo,
