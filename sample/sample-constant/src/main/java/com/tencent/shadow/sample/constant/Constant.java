...
final public class Constant {
    public static final String KEY__PLUGINS_ZIP_FILE__ABSOLUTE_PATH = "KEY__PLUGINS_ZIP_FILE__ABSOLUTE_PATH";
    public static final String KEY__TARGET_PLUGIN_ACTIVITY__CLASS_FULL_NAME = "KEY__TARGET_PLUGIN_ACTIVITY__CLASS_FULL_NAME";
    public static final String KEY__TARGET_PLUGIN_ACTIVITY__INTENT_EXTRAS = "KEY__TARGET_PLUGIN_ACTIVITY__INTENT_EXTRAS";
