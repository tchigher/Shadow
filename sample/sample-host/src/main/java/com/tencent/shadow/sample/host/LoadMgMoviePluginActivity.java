...
public class LoadMgMoviePluginActivity extends Activity {
        ...
        PluginHelper.getInstance().mSinglePool.execute(
                () -> {
                    HostApplication.getApp()
                            .loadPluginManager(PluginHelper.getInstance().mPluginManagerApkFile);

                    Bundle bundle = new Bundle();
                    bundle.putString(
                            Constant.KEY__PLUGIN_ZIP_FILE__ABSOLUTE_PATH,
                            PluginHelper.getInstance().mMgMoviePluginZipFile.getAbsolutePath()
                    );
                    bundle.putString(
                    ...
                    HostApplication.getApp().getPluginManager().enter(
                            LoadMgMoviePluginActivity.this,
