...
package gradle.kotlin.dsl.plugins._cbf9d4d41b65d34a546a6a2bab53021c
...
/**
 * The `bugly` plugin implemented by [com.tencent.bugly.gradle.BuglyPlugin].
 */
internal
val `PluginDependenciesSpec`.`bugly`: PluginDependencySpec
    get() = this.id("bugly")
...
/**
 * The `io.objectbox` plugin implemented by [io.objectbox.gradle.ObjectBoxGradlePlugin].
 */
internal
val `IoPluginGroup`.`objectbox`: PluginDependencySpec
    get() = plugins.id("io.objectbox")
...
/**
 * The `nopoint` plugin implemented by [com.migu.nopoint.InjectPluginImpl].
 */
internal
val `PluginDependenciesSpec`.`nopoint`: PluginDependencySpec
    get() = this.id("nopoint")
